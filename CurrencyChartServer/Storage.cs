...
namespace CurrencyChartServer
{
    internal static class Storage
    {
        ...
        static public void CheckDataInDb()
        {
            ...
            {
                Console.WriteLine("В кеше отсуствуют данные, выполняю запрос в НБРБ");
            }
            else
            {
                Console.WriteLine("Часть данных имеется в кеше, выполняю запрос в НБРБ");
            }
        }
        public static void SaveDataToCacheAndDb(Currency currency, RateShort[] rateShortsToSave)
        {
